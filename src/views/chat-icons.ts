...
export const ICON_MEMORIES = svg('<path d="M9 18c-3 0-5-2-5-5a4 4 0 0 1 1-3 4 4 0 0 1 4-6 3 3 0 0 1 3-2 3 3 0 0 1 3 2 4 4 0 0 1 4 6 4 4 0 0 1 1 3c0 3-2 5-5 5M12 2v20M8 9c2 0 4 1 4 3m4-3c-2 0-4 1-4 3M8 15c2 0 4 1 4 3m4-3c-2 0-4 1-4 3"/>')
export const ICON_SAFE_MODE = svg('<path d="m12 3 8 3v6c0 5-8 9-8 9s-8-4-8-9V6z"/><path d="m8 12 3 3 5-6"/>')
export const ICON_REASONING = svg('<path d="M9 18h6m-5 3h4M8 14a6 6 0 1 1 8 0c-1 1-1 2-1 4H9c0-2 0-3-1-4Z"/>')
